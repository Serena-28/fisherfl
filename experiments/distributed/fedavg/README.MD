...
## Usage
```
CUDA_VISIBLE_DEVICES=[gpus] sh run_fedavg_standalone_pytorch.sh [client_num_in_total] [client_num_per_round] [model] [comm_round] [epochs] [batch_size] [initial_lr] [dataset] [partition_alpha] [frequency_of_the_test]
```
