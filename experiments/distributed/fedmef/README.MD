...
## Quick Start
```
CUDA_VISIBLE_DEVICES=0,1,2,3 sh run_fedmef_distributed_pytorch.sh resnet18 cifar10 100 10 500 5 0.1 0.1 --delta_T 10 --T_end 300 --num_eval 128 --frequency_of_the_test 10 --enable_fedmef 1 --strategy mink --gamma 0.5 --lambda_l2 0.01 --num_of_lowest_k 5 --psi_of_lr 1.0 --max_lr 0.1
```

## Usage
[$\cdot$] is mandatory arguments, {$\cdot$} is the optional arguments.
```
CUDA_VISIBLE_DEVICES=[gpus] sh run_fedmef_distributed_pytorch.sh [model] [dataset] [client_num_in_total] [client_num_per_round]  [comm_round] [epochs] [target_density] [initial_lr]   {--delta_T , --T_end, --partition_alpha, --num_eval, --frequency_of_the_test, --enable_fedmef, --strategy, --gamma, --lambda_l2, --num_of_lowest_k, --psi_of_lr, --max_lr}
```
...
{--enable_fedmef} a switch of turning on/off BaE&SAP, 0 means turn off, 1 means turn on
...
{--num_of_lowest_k} k parameters with lowest magnitude
