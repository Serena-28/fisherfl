...
## Quick Start
```
CUDA_VISIBLE_DEVICES=0,1,2,3 sh run_fedust_distributed_pytorch.sh resnet18 cifar10 10 10 500 5 0.1 0.1 0.2 --delta_T 2 --T_end 300 --num_eval 128 --frequency_of_the_test 2
```
