...
class MyModelTrainer(ModelTrainer):
    ...
    def train(self, train_data, device, args, mode, round_idx = None, global_direction_map=None):
        ...
        if mode in [2, 3]:
            ...
            # pruning and growing
            model._prune_and_grow(weights, masks, local_direction_map, t=round_idx, alpha=args.adjust_alpha, T_end=args.T_end, lambda_k=args.lambda_param, beta_k=args.beta_param, global_direction_map=global_direction_map)
